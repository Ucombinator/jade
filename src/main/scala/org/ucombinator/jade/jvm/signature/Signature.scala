...
object Signature {
  ...
  final case object Extends extends WildcardIndicator // +
  final case object Super extends WildcardIndicator   // -

  //// A "type variable signature" represents a type variable.
  final case class TypeVariableSignature(name: Identifier) extends ReferenceTypeSignature with ThrowsSignature
  ...
  final case object VoidDescriptor extends Result // V
}
