...
object Parser extends JavaTokenParsers {
  ...
  def parseJavaTypeSignature(signature: CharSequence): ParseResult[JavaTypeSignature] = {
    parseAll(javaTypeSignature, signature)
  }

  def parseClassSignature(signature: CharSequence): ParseResult[ClassSignature] = {
    parseAll(classSignature, signature)
  }

  def parseMethodSignature(signature: CharSequence): ParseResult[MethodSignature] = {
    parseAll(methodSignature, signature)
  }
