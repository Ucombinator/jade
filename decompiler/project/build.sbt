...
addSbtPlugin("com.timushev.sbt" % "sbt-updates" % "0.5.1") // Provides `sbt dependencyUpdates`. Copying this line to `~/.sbt/1.0/plugins/sbt-updates.sbt` also provides `sbt ";dependencyUpdates; reload plugins; dependencyUpdates"`
